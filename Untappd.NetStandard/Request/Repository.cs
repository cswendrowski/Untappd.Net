...
namespace Untappd.NetStandard.Request
{
    public sealed partial class Repository
    {
        ...
        public Repository(IRestClient client, IRestRequest request)
        {
            Client = client;
            Request = request;
        }

        public Repository ConfigureRequest(string endPoint, IDictionary<string, object> bodyParameters = null, Method webMethod = Method.GET)
        {
        ...
        public Repository ConfigureRequest(IUntappdCredentials credentials, string endPoint, IDictionary<string, object> bodyParameters = null, Method webMethod = Method.GET)
        {
